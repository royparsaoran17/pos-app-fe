<template>
  <AdminCrud
    ...
    :default-form-data="() => ({ key: '', label: '', price: 0, hpp: 0, max_toppings: null, sort_order: 0 })"
    :map-row-to-form="(r) => ({ key: r.key, label: r.label, price: r.price, hpp: r.hpp || 0, max_toppings: r.max_toppings, sort_order: r.sort_order })"
